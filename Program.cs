        ...
        static void Main(string[] args)
        {
            ...
            using (FileStream fileStream = new FileStream(@"D:\spssparsing\wacokMom\Moms_Dec2018_SPSS (1).sav", FileMode.Open, FileAccess.Read, FileShare.Read, 2048 * 10, FileOptions.SequentialScan))
            {
                ...
                foreach (var record in spssDataset.Records)
                {
                    ...
                    string BrSpont_Roma_sandwich = "-- Not Available --";
                    string AdSpont_Roma_sandwich = "-- Not Available --";
                    string ConL1M_BrSpont_Roma_sandwich = "-- Not Available --";
                    string ConL3M_Roma_sandwich = "-- Not Available --";
                    string ConL1W_Roma_sandwich = "-- Not Available --";
                    string ConYestOrToday_Roma_sandwich = "-- Not Available --";
                    string CFEB31a1 = "-- Not Available --";
                    string CFEB31a4 = "-- Not Available --";
                    string CFEB31a6 = "-- Not Available --";
                    string CFEB31a10 = "-- Not Available --";
                    string CFEB31b2 = "-- Not Available --";
                    string CFEB31b5 = "-- Not Available --";
                        ...
                        foreach (string spss_v in spss_variable_name)
                        {
                            if (variable.Name.Equals(spss_v))
                            {
                                ...
                                switch (variable_name)
                                {
                                    ...
                                    case "C2_21": { BrSpont_Roma_sandwich = Convert.ToString(record.GetValue(variable)); break; }
                                    case "C9_21": { AdSpont_Roma_sandwich = Convert.ToString(record.GetValue(variable)); break; }
                                    case "C11_21": { ConL1M_BrSpont_Roma_sandwich = Convert.ToString(record.GetValue(variable)); break; }
                                    case "C10_21": { ConL3M_Roma_sandwich = Convert.ToString(record.GetValue(variable)); break; }
                                    case "C12_21": { ConL1W_Roma_sandwich = Convert.ToString(record.GetValue(variable)); break; }
                                    case "C13_21": { ConYestOrToday_Roma_sandwich = Convert.ToString(record.GetValue(variable)); break; }
                                    case "CFEB31a1": { CFEB31a1 = Convert.ToString(record.GetValue(variable)); break; }
                                    case "CFEB31a4": { CFEB31a4 = Convert.ToString(record.GetValue(variable)); break; }
                                    case "CFEB31a6": { CFEB31a6 = Convert.ToString(record.GetValue(variable)); break; }
                                    case "CFEB31a10": { CFEB31a10 = Convert.ToString(record.GetValue(variable)); break; }
                                    case "CFEB31b2": { CFEB31b2 = Convert.ToString(record.GetValue(variable)); break; }
                                    case "CFEB31b5": { CFEB31b5 = Convert.ToString(record.GetValue(variable)); break; }
                                }
